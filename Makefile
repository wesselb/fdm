...
autodoc:
	rm -rf doc/source
	sphinx-apidoc -eMT -o doc/source/ fdm
	rm doc/source/fdm.rst
...
test:
	python /usr/local/bin/nosetests tests --with-coverage --cover-html --cover-package=fdm -v --logging-filter=fdm
